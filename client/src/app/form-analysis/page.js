...
function VideoFormAnalysisContent() {
  useDocumentMetadata({
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
export default function VideoFormAnalysis() {
  return (
    <ProtectedRoute>
      <VideoFormAnalysisContent />
    </ProtectedRoute>
  );
}
