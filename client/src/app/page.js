...
function StrongArmIcon({ className }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.006 15.006a1.125 1.125 0 110-2.25 1.125 1.125 0 010 2.25zm.375-5.25a1.125 1.125 0 110-2.25 1.125 1.125 0 010 2.25zM12 21.75l-4.243-4.243m4.243 4.243l4.243-4.243m-4.243 4.243V3.375C12 3.09 11.758 2.85 11.458 2.85h-.916c-.3 0-.542.24-.542.525V17.506h-.006c-1.637 0-3.238.56-4.506 1.579l-1.353.942a.75.75 0 00-.236.634v.857c0 .285.242.525.542.525H12Z" />
    </svg>
  );
}
...
export default function Home() {
  ...
  return (
    <div className="mt-6 space-y-8 page page-shell max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
      {error && (
        <div className="card p-4 border-orange-400/40">
        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link id="btn-home-log-workout" href="/forge" className="bg-gradient-to-r from-[#ff5a1f] to-orange-500 hover:from-orange-500 hover:to-pink-500 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg shadow-orange-500/30 hover:-translate-y-0.5 active:scale-95">Log workout</Link>
              <Link id="btn-home-log-meal" href="/fuel" className="bg-white/10 hover:bg-white/20 text-white backdrop-blur-md border border-white/10 px-6 py-3 rounded-xl font-bold transition-all hover:-translate-y-0.5 active:scale-95">Log meal</Link>
              {!user && <Link id="btn-home-create-account" href="/auth" className="bg-white/10 hover:bg-white/20 text-white backdrop-blur-md border border-white/10 px-6 py-3 rounded-xl font-bold transition-all hover:-translate-y-0.5 active:scale-95">Create account</Link>}
            </div>
